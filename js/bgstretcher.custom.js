...
;(function($){
					...
					if (ext != 'swf') {
						...
						for(i = 0; i < settings.images.length; i++){
							...
							if ($.fn.bgStretcher.settings.preloadImg) {
									...
									code += '<li class="img-loaded"><img src="' + settings.images[ind].src + '" alt="' + settings.images[ind].alt + '" /></li>';
								}		
						}
					} else {
	...
	$.fn.bgStretcher.goto = function(index){
		$(allLIs).stop(true, true);
		$.fn.bgStretcher._clearTimeout();
		$.fn.bgStretcher.slideShow($.fn.bgStretcher.settings.sequenceMode, index);
	};
